...
async def chat_with_gemini(data: ChatMessage):
    ...
    if settings.OPENAI_API_KEY:
        ...
        if is_openrouter:
            ...
            # Usamos el modelo gratis de Gemini 2.5 Flash, y como fallback el de Llama 3
        ...
        try:
            ...
            # Fallback en caso de que el modelo gratis de OpenRouter falle, intentar con Llama 3 gratis
            if is_openrouter and "google/gemini-2.5-flash:free" in model_name:
                logger.info("Intentando fallback a Llama 3 8B en OpenRouter...")
                try:
